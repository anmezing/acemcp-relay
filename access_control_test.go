...
func TestTrustedConsoleRequest(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "read client version policy", method: http.MethodGet, path: "/internal/client-version-policy", token: validToken, want: true},
		{name: "write client version policy", method: http.MethodPost, path: "/internal/client-version-policy", token: validToken, want: true},
